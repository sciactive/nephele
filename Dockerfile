...
LABEL org.opencontainers.image.version="1.0.0-alpha.43"
...
RUN npm i -g pm2 nephele-serve@1.0.0-alpha.43
...
#  docker buildx build --platform linux/amd64,linux/arm64 -t sciactive/nephele:latest -t sciactive/nephele:1.0.0-alpha.43 --push .
